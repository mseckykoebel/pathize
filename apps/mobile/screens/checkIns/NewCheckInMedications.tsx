...
const NewCheckInMedications: React.FC<Props> = ({route}) => {
    ...
    <>
      ...
      <AppBodyLayout
        ...
        absoluteBottomChild={
          <PrimaryButton
            ...
            onPress={() => {
              ...
              checkInNavigation.navigate('NewCheckInSymptoms', {
                checkIn: {
                  ...checkIn,
                  medications: [],
                },
        ...
        <View style={tw`flex flex-row justify-between items-center`}>
          {/* HEADER (MODIFIED) */}
          <Header1
            text="Select one or more medications+ to track"
            style={[
          ...
          {selectedDropdownItem && sortedUserMedications ? (
            <TouchableOpacity
              ...
              onPress={() => {
                trigger('impactLight');
                setPickerSource('newCheckInMedications');
        ...
        {/* PICKER OVERLAY */}
        {pickerVisible && pickerSource === 'newCheckInMedications' && (
          <PickerOverlaySheet
            items={dropdownItems}
            selectedItem={selectedDropdownItem}
            setSelectedItem={setSelectedDropdownItem}
            labelKey="name"
            portalHost="newCheckInMedications"
          />
        )}
        {/* LOADING */}
...
export default NewCheckInMedications;
