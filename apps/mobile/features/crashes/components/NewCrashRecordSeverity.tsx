...
const NewCrashRecordSeverity: React.FC<Props> = ({route}) => {
  ...
  const crashNavigation =
    useNavigation<
      StackNavigationProp<CrashNavigatorParamList, 'NewCrashRecordSeverity'>
    >();
        ...
        <View style={tw`pt-5 w-50 mx-auto`}>
          <DarkButton
            onPress={() => {
              ...
              posthog?.capture('Save crash severity time button pressed', {
                $screen_name: 'Home',
...
export default NewCrashRecordSeverity;
