import React, {useEffect, useContext, useMemo, ReactNode} from 'react';
...
export function LineChartPathWrapper({
  ...
  const {height, pathWidth, width} = useContext(LineChartDimensionsContext);
  ...
  const viewSize = useMemo(() => ({width, height}), [width, height]);
