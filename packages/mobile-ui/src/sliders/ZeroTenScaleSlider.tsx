...
const getPadding = (value: number) => {
  switch (value) {
    ...
    case 4:
      return 8;
    case 5:
      return 0; // TODO: for some reason this has no effect
    case 6:
      return 60;
    case 7:
      return 40;
...
export const ZeroTenScaleSlider: React.FC<Props> = ({
  headerText,
  sliderStartText,
  sliderEndText,
  setValue,
  ...
  const handleSliding = (value: number) => {
    ...
    const xOffset =
      (value / 10) * effectiveSliderWidth + padding - tooltipWidth / 2;
